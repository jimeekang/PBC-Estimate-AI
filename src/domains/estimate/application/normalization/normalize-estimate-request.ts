import { clearGlobalPaintAreasForSpecificScope } from '@/domains/estimate/domain/flow/estimate-flow-logic';
import type { EstimateRequest } from '@/domains/estimate/domain/schemas/estimate-request';
