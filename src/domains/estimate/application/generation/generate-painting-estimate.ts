...
import { calculateExteriorEstimate } from '@/domains/estimate/application/generation/generate-painting-estimate.exterior';
import { isInteriorTrimItemOnly } from '@/domains/estimate/domain/flow/estimate-flow-logic';
import { clampInteriorRangeForOutput } from '@/domains/estimate/domain/pricing/output-range';
import { EXTERIOR_RESTRICTED_PROPERTY_TYPES } from '@/domains/estimate/domain/estimate-constants';
import {
  InteriorRoomItemSchema,
  SkirtingCalculatorRoomSchema,
} from '@/domains/estimate/domain/schemas/estimate';
import {
  ...
  getQtyScaleFactor,
} from '@/domains/estimate/domain/pricing/pricing-engine';

// -----------------------------
// Anchors (Sydney averages)
// -----------------------------

// NOTE: Anchors, SQM curve, and pricing constants are imported from the estimate pricing domain.
...
// and EXTERIOR_AREA_UPLIFT_PCT are imported from '@/domains/estimate/domain/pricing/pricing-engine'.

// INTERIOR_DOOR_ITEM_ANCHOR, INTERIOR_WINDOW_ITEM_ANCHOR imported from '@/domains/estimate/domain/pricing/pricing-engine'.
...
// EXTERIOR_ARCHITRAVE_ANCHOR, getQtyScaleFactor, calcTrimItemCost — imported from '@/domains/estimate/domain/pricing/pricing-engine'.

// -----------------------------
// Helpers
// -----------------------------
// clamp, getInteriorHandrailWidthMultiplier, estimateWallArea, pickExteriorBand
// are imported from '@/domains/estimate/domain/pricing/pricing-engine'.
...
// sumAreaFactor imported from '@/domains/estimate/domain/pricing/pricing-engine'.
...
// sumAreaFactorWholeApartment imported from '@/domains/estimate/domain/pricing/pricing-engine'.
...
// inferHouseKey imported from '@/domains/estimate/domain/pricing/pricing-engine'.

// -----------------------------
// RANGE CAP POLICY (dynamic) — capRangeWidthSmart, lerp, interpolateBySqm imported from '@/domains/estimate/domain/pricing/pricing-engine'.
// Interior/Total: $0~5k→1,200 / $5k~10k→1,800 / $10k~18k→2,500 / $18k+→3,500
// Exterior:       $0~10k→1,500 / $10k~20k→2,500 / $20k+→4,000
// -----------------------------

// -----------------------------
// 3B2B FAIR (House) curve — CAL_3B2B_FAIR_SINGLE_POINTS imported from '@/domains/estimate/domain/pricing/pricing-engine'.
// -----------------------------
...
// -----------------------------
// Double storey 3B2B uplift — DOUBLE_STOREY_3B2B_UPLIFT imported from '@/domains/estimate/domain/pricing/pricing-engine'.
// -----------------------------
