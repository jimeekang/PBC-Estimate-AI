...
const contentSecurityPolicy = [
  ...
  "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://*.google.com https://*.gstatic.com https://*.recaptcha.net https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://maps.googleapis.com https://maps.gstatic.com https://firebaseinstallations.googleapis.com",
